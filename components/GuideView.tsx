      ...
      <InfoCard title="Баллы" icon="🪙">
        ...
        <ul className="list-disc list-inside space-y-1">
          ...
          <li>
           ...
           <li>
            <strong>Победа в играх:</strong> Вы забираете ставку оппонента в Дуэлях, Шахматах и Крестиках-ноликах.
          </li>
        </ul>
        <h4 className="font-semibold text-tg-text pt-2">На что потратить:</h4>
        <ul className="list-disc list-inside space-y-1">
           <li>
            <strong>Дуэль (Камень-Ножницы-Бумага):</strong> -10🪙
          </li>
          <li>
            <strong>Шахматы:</strong> -25🪙
          </li>
           <li>
            <strong>Крестики-нолики:</strong> -5🪙
          </li>
          <li>
